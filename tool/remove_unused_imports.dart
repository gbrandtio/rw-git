...
void main() {
  removeImport('lib/src/intelligence/interpretation/models/report_payload.dart',
  ...
  removeImport('test/intelligence/interpretation/finding_basis_test.dart',
  ...
  removeImport(
      ...
      "import 'package:rw_git/src/intelligence/interpretation/models/analysis_type.dart';\n");
  removeImport('test/mcp/mcp_tool_hints_decorator_test.dart',
      "import 'package:rw_git/src/intelligence/interpretation.dart';\n");
}
