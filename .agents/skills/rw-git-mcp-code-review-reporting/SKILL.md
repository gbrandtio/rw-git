...
description: "Code-review & integration-risk report using the one-call generate_code_review_report tool (secrets, complexity outliers, single-owner files, bug hotspots), plus analyze_pr_diff / predict_merge_conflicts for diff-specific detail."
---
