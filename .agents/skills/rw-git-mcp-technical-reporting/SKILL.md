---
name: rw-git-mcp-technical-reporting
description: "Technical report on code quality, technical debt, and architecture using the one-call generate_technical_report tool, which returns already-classified, ranked findings (complexity, churn, ownership, bug hotspots, coupling, volatility)."
---
