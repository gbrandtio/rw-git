...
class CalculateUniversalLexicalMetricsTool implements McpTool {
  ...
  Future<String> execute(Map<String, dynamic> arguments) async {
    ...
    // Run heuristics
    final cyclomatic = CyclomaticComplexityAlgorithm().calculate(
      tokens,
      profile,
    );
    ...
    final indentation = IndentationComplexityAlgorithm().calculate(
      tokens,
      profile,
    );
    final maintainability = MaintainabilityIndexAlgorithm().calculate(
      tokens,
      profile,
    );
