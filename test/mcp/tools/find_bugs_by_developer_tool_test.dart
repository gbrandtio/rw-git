...
void main() {
  ...
  setUp(() {
    ...
    tracker = CodeQualityTracker(mockRunner);
    tool = FindBugsByDeveloperTool(tracker);
  });
  ...
  group('FindBugsByDeveloperTool', () {
    ...
    test('execute returns valid JSON with introduced bugs', () async {
      ...
      final introducingCommit =
          bug['introducingCommit'] as Map<String, dynamic>;
      expect(introducingCommit['hash'],
          'fedcba9876543210fedcba9876543210fedcba98');
      expect(introducingCommit['authorName'], 'Target Author');

      final fixingCommits = bug['fixingCommits'] as List;
